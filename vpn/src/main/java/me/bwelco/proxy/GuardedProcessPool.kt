...
class GuardedProcessPool {
    ...
    private inner class Guard(private val cmd: List<String>,
                              private val onRestartCallback: (() -> Unit)?,
    ...
    fun start(cmd: List<String>, context: Context, onRestartCallback: (() -> Unit)? = null): GuardedProcessPool {
        val guard = Guard(cmd, onRestartCallback, context)
